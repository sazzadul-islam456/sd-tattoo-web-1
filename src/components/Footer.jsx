        ...
        <motion.div
          ...
          <motion.div
            ...
            tracking-[0.08em]'>
              {about.title}</div>
            {/* subtitle */}
            <div className='leading-realaxed text-[#dbdbdb]'>
              {about.subtitle}</div>
            {/* address, phone email */}
          ...
          <motion.div
            ...
            className='flex-1'>
            <div className='font-primary text-xl
             uppercase tracking-[0.08em mb-6]'>{program.title}</div>
          ...
          <motion.div
            ...
            className='flex-1'>
            <div className='font-primary text-xl
             uppercase tracking-[0.08em] mb-6'>{newsletter.title}</div>
            <div className='leading-relaxed mb-9 text-[#dbdbdb]'>{newsletter.subtitle}</div>
            <form className='flex justify-between 
            items-start border-b border-[#b6b6b6]'>
              <input className='outline-none 
              placeholder-base italic
