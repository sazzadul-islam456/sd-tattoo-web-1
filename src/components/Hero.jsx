...
import { heroData } from "../data"; // Import heroData from data file
  ...
  return (
    ...
    >
      <motion.div
        ...
        initial="hidden"
        whileInView={"show"}
        className="container mx-auto min-h-[40vh] lg:h-full flex 
      ...
      >
        ...
        >
          ...
          variants={fadeIn('down')}
            className="mb-8 lg:md-16 max-w-lg
          leading-relaxed"
          >
            {subtitle}
          </motion.p>
        ...
        {/* outline text */}
        <div
          className="hidden xl:flex absolute -bottom-2 
        right-0 left-0 before:content-outlineText"
        ></div>
      </motion.div>
    </section>
  );
